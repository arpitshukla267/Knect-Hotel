...
export default function Contact() {
  return (
    <div
      className="min-h-screen text-white font-[Marcellus] flex flex-col items-center py-20"
      style={{
        background:
    ...
    >
      ...
      <section className="w-full flex flex-col items-center pt-20 px-4 sm:px-8 md:px-20 lg:px-40">
        ...
        <div className="flex flex-col-reverse md:flex-row justify-center items-stretch gap-8 sm:gap-10 w-full pt-6 sm:pt-10 relative">
          ...
          <div className="md:w-1/2 w-full p-4 sm:p-6 md:p-8 flex flex-col justify-start">
            ...
            <form suppressHydrationWarning className="space-y-4">
