...
export default function Page() {
  ...
  const features = [
    {
      ...
      desc: "Automatically adjust room rates based on real-time demand, competitor pricing, and occupancy trends.",
    },
    {
      icon: <FiBarChart2 size={28} color="#ffffff" />,
      title: "Advanced Revenue Forecasting",
      desc: "Predict future revenue performance with AI-powered forecasting to plan smarter and sell better.",
    },
    {
      icon: <FiDollarSign size={28} color="#ffffff" />,
      title: "Rate Optimization",
      desc: "Identify the best price for every room type to maximize yield without hurting conversion rates.",
    },
    {
      icon: <FiActivity size={28} color="#ffffff" />,
      title: "Performance Analytics",
      desc: "Access detailed insights on ADR, RevPAR, occupancy, and channel performance in real time.",
    },
    {
      icon: <FiCalendar size={28} color="#ffffff" />,
      title: "Event & Season Awareness",
      desc: "Automatically detect local events, holidays, and seasonality spikes to boost rates intelligently.",
    },
    {
      icon: <FiPieChart size={28} color="#ffffff" />,
      title: "Profitability Dashboard",
      desc: "Get a holistic view of revenue streams, booking trends, and profit performance from one screen.",
    },
    {
      title: "Rate Strategy Automation",
      desc: "Set custom rules and conditions to let the system handle rate adjustments automatically.",
    },
    {
      title: "Multi-property Insights",
      desc: "Compare revenue metrics across all your hotels to make data-backed management decisions.",
    },
    {
      title: "Competitor Rate Intelligence",
      desc: "Stay ahead with live competitor rate tracking and market performance benchmarks.",
    },
  ];
  ...
  const aboutFeatures = [
    {
      id: 1,
      img: "/revenue-manager-1.png",
      subtitle: "Predictive Analytics",
      title: "Turn data into revenue decisions",
      desc: "Leverage machine learning algorithms that forecast demand and recommend optimal pricing strategies instantly.",
    },
    {
      id: 2,
      img: "/revenue-manager-2.png",
      subtitle: "Automated Intelligence",
      title: "Set once, let automation handle the rest",
      desc: "Automate pricing rules, restrictions, and inventory allocation to maintain full control with minimal effort.",
    },
    {
      id: 3,
      img: "/revenue-manager-3.png",
      subtitle: "Market Comparison",
      title: "Benchmark performance with live data",
      desc: "Compare your rates, occupancy, and performance KPIs against local competitors in real time.",
    },
    {
      id: 4,
      img: "/revenue-manager-4.png",
      subtitle: "Real-Time Insights",
      title: "Track what matters instantly",
      desc: "View real-time analytics with customizable dashboards showing performance, revenue, and demand patterns.",
    },
    {
      id: 5,
      img: "/pms-image-4.jpg",
      ...
      desc: "Revenue Manager integrates seamlessly with KnectHotel PMS, Channel Manager, and Booking Engine for unified growth.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <section className="w-full min-h-screen md:h-screen flex flex-col-reverse md:flex-row items-center justify-between gap-10 px-8 md:px-20 py-24">
        ...
        >
          <h1 className="text-3xl md:text-6xl font-extrabold leading-tight text-gray-300">
            Maximize profit potential with{" "}
            <span className="text-[#9a753e]">Revenue Manager</span>
          </h1>
          <p className="text-gray-400 text-md md:text-lg">
            Automate pricing, forecast demand, and make smarter decisions to drive consistent revenue growth.
          </p>
        ...
        >
          <Image
            src="/revenue-hero.png"
            alt="Revenue Manager Hero"
            width={700}
            height={500}
      ...
      <section className="relative w-full py-24 md:py-32 px-4 sm:px-10 lg:px-20 overflow-hidden">
        ...
        >
          Make smarter pricing moves with{" "}
          <motion.span
      ...
      <section className="w-full h-[400px] flex flex-col justify-center items-center py-20 bg-black/50">
        <h2 className="text-2xl md:text-4xl font-semibold mb-6">
          Try <span className="text-[#9a753e]">KnectHotel</span> Revenue Manager for free
        </h2>
        <p className="text-gray-300 max-w-xs md:max-w-3xl text-sm md:text-md text-center">
          Automate pricing, forecast demand, and optimize your strategy for consistent revenue growth—all from one intelligent platform.
        </p>
